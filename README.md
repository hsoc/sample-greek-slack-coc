...
Η SKGtech είναι μια ομάδα από ανθρώπους δημιουργικούς και παθιασμένους με την τεχνολογία.  Απαρτίζεται από άτομα που συμμετέχουν στις τεχνολογικές κοινότητες της Θεσσαλονίκης και μαζί με τις δράσεις της για την προώθηση και υλοποίηση τεχνολογιών στην πόλη για κοινωφελείς σκοπούς, προσφέρει ένα κανάλι επικοινωνίας για networking, για συνεργασίες και για αύξηση της τεχνογνωσίας.
